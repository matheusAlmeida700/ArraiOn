        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-orange-py-16 px-8 bg-opacity-20 rounded-lg p-8 mb-8">
            <p className="text-xl text-junina-brown leading-relaxed font-poppins">
              Ô trem bão, sô! Bem-vindo ao ArraiáON, a plataforma que transforma
              a sua espera numa festança! Enquanto tu tá na fila, se divirta com
              nossos joguinhos arretados, acumule XP e garanta seu voucher pra
              aproveitar ainda mais o arraiá. Bata o chapéu e vem brincar com a
              gente! Simbora aproveitar, sô!
            </p>
          </div>

          <button
            onClick={handleEnterFesta}
            className="bg-amber-900 text-white px-12 py-4 rounded-lg text-xl font-bold btn-junina transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
            BORA MEU FI!
          </button>
        </div>
