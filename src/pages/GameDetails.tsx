...
const gameDetails = {
  'quiz': {
    name: 'Quiz Junino',
    description: 'Teste seus conhecimentos sobre a cultura junina brasileira! Responda perguntas sobre tradições, comidas típicas, danças e muito mais.',
    icon: '🎓',
    xp: '10-30 XP',
  ...
  'memory': {
    ...
    description: 'Encontre os pares dos símbolos juninos escondidos! Teste sua memória com elementos tradicionais da festa.',
    icon: '🧠',
    xp: '15-25 XP',
    category: 'Memória',
    difficulty: 'Médio',
  ...
  'reaction': {
    ...
    description: 'Clique nos fogos de artifício no momento exato! Teste seus reflexos com uma explosão de cores.',
    icon: '🎆',
    xp: '20-40 XP',
    category: 'Reflexo',
    difficulty: 'Difícil',
  ...
  'pin-the-tail': {
    name: 'Acerte o Alvo',
    description: 'Mire com precisão e acerte o centro do alvo! Quanto mais próximo do centro, maior a pontuação.',
    icon: '🎯',
    xp: '10-50 XP',
    category: 'Precisão',
    difficulty: 'Médio',
  ...
  'rhythm': {
    ...
    description: 'Siga o ritmo da música junina! Toque no tempo certo e mantenha o compasso da festa.',
    icon: '🎵',
    xp: '15-35 XP',
    category: 'Ritmo',
    difficulty: 'Médio',
  ...
  'number': {
    name: 'Bingo Caipira',
    description: 'Encontre os números sorteados o mais rápido possível! Um bingo especial com o sabor da roça.',
    icon: '🎲',
    xp: '10-30 XP',
    category: 'Sorte',
    difficulty: 'Fácil',
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white p-4 flex items-center justify-center">
        <div className="text-center">
          ...
          <Button onClick={() => navigate('/games')} className="bg-purple-600 hover:bg-purple-700">
            Voltar aos Jogos
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white">
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8 border border-purple-400/30">
          <h2 className="text-2xl font-bold mb-4 text-purple-300">Como Jogar</h2>
        ...
        {/* Badges Preview */}
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 mb-8 border border-purple-400/30">
          <h2 className="text-2xl font-bold mb-4 text-purple-300">Conquistas Disponíveis</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {game.badges.map((badge, index) => (
              <div key={index} className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-lg p-4 border border-yellow-400/30 text-center">
