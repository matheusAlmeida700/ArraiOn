  ...
  return (
    <div className="min-h-screen festa-bg text-white flex items-center justify-center p-4 lg:p-8 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'linear-gradient(135deg, rgba(139, 92, 246, 0.8), rgba(236, 72, 153, 0.7)), url(https://images.unsplash.com/photo-1466721591366-2d5fba72006d?w=1200)',
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-10">
        ...
        <div className="absolute top-20 left-10 lg:left-20 text-6xl lg:text-8xl opacity-20 animate-parallax-float">🎪</div>
        <div className="absolute top-40 right-10 lg:right-20 text-4xl lg:text-6xl opacity-15 animate-bounce-gentle" style={{ animationDelay: '1s' }}>🌽</div>
        <div className="absolute bottom-40 left-10 lg:left-20 text-5xl lg:text-7xl opacity-25 animate-float" style={{ animationDelay: '2s' }}>🎭</div>
        <div className="absolute bottom-20 right-10 lg:right-10 text-4xl lg:text-5xl opacity-20 animate-bounce-gentle" style={{ animationDelay: '3s' }}>🔥</div>
        <div className="absolute top-1/2 left-1/4 text-3xl lg:text-4xl opacity-10 animate-pulse">🎵</div>
        <div className="absolute top-1/4 right-1/4 text-3xl lg:text-4xl opacity-10 animate-pulse" style={{ animationDelay: '2s' }}>🎯</div>
      </div>

      <div className={`text-center max-w-lg lg:max-w-2xl mx-auto transition-all duration-1000 z-20 relative ${isLoaded ? 'animate-scale-in' : 'opacity-0'}`}>
        {/* Enhanced decorative elements */}
        <div className="mb-8 lg:mb-12 relative">
          <div className="text-7xl lg:text-9xl xl:text-[10rem] animate-tada mb-6 text-shadow-strong">🎪</div>
          <div className="absolute -top-4 -right-8 lg:-right-12 text-3xl lg:text-4xl animate-bounce delay-300">🌽</div>
          <div className="absolute -bottom-4 -left-8 lg:-left-12 text-3xl lg:text-4xl animate-bounce delay-500">🎭</div>
        </div>
